...
<p align="center">
  <b>RelayAgent is a mobile agent that decomposes a user request into subtasks, then delegates them to in-app AI assistants (e.g. Qwen assistant, RedNote's Dot, WeChat's AI assistant, Google Gemini) to complete the full request.</b>
</p>
